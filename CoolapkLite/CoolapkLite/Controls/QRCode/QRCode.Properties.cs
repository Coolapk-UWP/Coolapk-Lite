...
namespace CoolapkLite.Controls
{
    public partial class QRCode
    {
        ...
        /// <summary>
        /// Identifies the <see cref="HasRadius"/> dependency property.
        /// </summary>
        public static readonly DependencyProperty HasRadiusProperty =
            DependencyProperty.Register(
                nameof(HasRadius),
                typeof(bool),
                typeof(QRCode),
        ...
        {
            get => (bool)GetValue(HasRadiusProperty);
            set => SetValue(HasRadiusProperty, value);
        }
