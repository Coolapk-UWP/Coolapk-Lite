...
namespace CoolapkLite.Controls
{
    ...
    public partial class ListDetailsView : ItemsControl
    {
        ...
        protected override void OnApplyTemplate()
        {
            ...
            _twoPaneView = (TwoPaneView)GetTemplateChild(PartRootPanel);
        ...
        private void OnLoaded(object sender, RoutedEventArgs e)
        {
            if (!DesignMode.DesignModeEnabled)
            {
                ...
                _navigationView = this.FindAscendant<NavigationView>();
        ...
        private void UpdateViewState()
        {
            ...
            else if (_twoPaneView.Mode == TwoPaneViewMode.SinglePane)
            {
                ...
                _twoPaneView.PanePriority = SelectedItem == null ? TwoPaneViewPriority.Pane1 : TwoPaneViewPriority.Pane2;
            }
