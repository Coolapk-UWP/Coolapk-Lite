...
namespace CoolapkLite.Helpers
{
    ...
    public static class UriHelper
    {
        ...
        {
            string uri = string.Format(GetTemplate(type), args);
            return new Uri(IsUseAPI2 ? Base2Uri : BaseUri, uri);
        }
        ...
        private static string GetTemplate(UriType type)
        {
            switch (type)
            {
                ...
                case UriType.GetReplyReplies: return "/v6/feed/replyList?id={0}&page={1}{2}{3}&feedType=feed_reply";
                case UriType.GetSearchWords: return "/v6/search/suggestSearchWordsNew?searchValue={0}&type=app";
                case UriType.GetShareList: return "/v6/feed/forwardList?id={0}&type={1}&page={2}{3}{4}";
                case UriType.GetTagDetail: return "/v6/topic/newTagDetail?tag={0}";
                case UriType.GetTagFeeds: return "/v6/topic/tagFeedList?tag={0}&page={1}{2}{3}&listType={4}";
                case UriType.GetTopicDetail: return "/v6/topic/tagDetail?tag={0}";
                case UriType.GetDeviceFeeds: return "/v6/topic/deviceFeedList?tag={0}&page={1}{2}{3}&listType={4}";
                ...
                case UriType.Search: return "/v6/search?type={0}&searchValue={1}&page={2}{3}{4}&showAnonymous=-1";
                case UriType.SearchTarget: return "/v6/search?type={0}&feedType={1}&sort={2}&searchValue={3}&pageType={4}&pageParam={5}&page={6}{7}{8}&showAnonymous=-1";
                case UriType.SearchFeeds: return "/v6/search?type=feed&feedType={0}&sort={1}&searchValue={2}&page={3}{4}{5}&showAnonymous=-1";
                case UriType.SearchWords: return "/v6/search/suggestSearchWordsNew?searchValue={0}&type=app";
                case UriType.SearchCreateTags: return "/v6/feed/searchTag?q={0}&page={1}{2}{3}";
                case UriType.SearchCreateUsers: return "/v6/user/search?q={0}&page={1}{2}{3}";
