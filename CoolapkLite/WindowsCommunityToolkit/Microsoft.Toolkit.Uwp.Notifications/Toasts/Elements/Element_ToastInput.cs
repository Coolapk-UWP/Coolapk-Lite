...
namespace Microsoft.Toolkit.Uwp.Notifications
{
    internal sealed class Element_ToastInput : IElement_ToastActionsChild, IHaveXmlName, IHaveXmlNamedProperties, IHaveXmlChildren
    {
        ...
        IEnumerable<KeyValuePair<string, object>> IHaveXmlNamedProperties.EnumerateNamedProperties()
        {
            ...
            yield return new KeyValuePair<string, object>("type", Type.ToPascalCaseString());
            yield return new KeyValuePair<string, object>("title", Title);
            yield return new KeyValuePair<string, object>("placeHolderContent", PlaceholderContent);
            yield return new KeyValuePair<string, object>("defaultInput", DefaultInput);
        }
    }
