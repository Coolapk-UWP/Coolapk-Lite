...
namespace Microsoft.Toolkit.Uwp.Notifications
{
    internal sealed class Element_TileBinding : IElementWithDescendants, IHaveXmlName, IHaveXmlNamedProperties, IHaveXmlChildren
    {
        ...
        {
            yield return new KeyValuePair<string, object>("template", Template);
            ...
            {
                yield return new KeyValuePair<string, object>("branding", Branding);
            }

            yield return new KeyValuePair<string, object>("contentId", ContentId);
            ...
            yield return new KeyValuePair<string, object>("hint-lockDetailedStatus1", LockDetailedStatus1);
            yield return new KeyValuePair<string, object>("hint-lockDetailedStatus2", LockDetailedStatus2);
            yield return new KeyValuePair<string, object>("hint-lockDetailedStatus3", LockDetailedStatus3);
            yield return new KeyValuePair<string, object>("arguments", Arguments);
            yield return new KeyValuePair<string, object>("hint-presentation", Presentation.ToPascalCaseString());

            if (TextStacking != DEFAULT_TEXT_STACKING)
            {
                yield return new KeyValuePair<string, object>("hint-textStacking", TextStacking.ToPascalCaseString());
            }
        }
    }
